...
extern ADC_HandleTypeDef hadc1; // Vin Current Sense
extern ADC_HandleTypeDef hadc2; // Vin Voltage Sense

// ADC / 4096 * 2.5V / 100V/V / 0.03 Ohm * 1000mA/A = ADC * 0.203mA = ADC / 5
#define BATT_CURR_SCALAR_DIV 5
#define BATTERY_CURRENT_THRESHOLD 100

// ADC / 4096 * 2.5V * 5 * 1000 mV/V = ADC * 3.051mV
#define BATT_VOLT_SCALAR_MUL 3
